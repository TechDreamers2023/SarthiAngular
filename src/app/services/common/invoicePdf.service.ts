                                ...
                                stack: [
                                    {
                                        columns: [
                                            ...
                                            {
                                                text: data.vendorDetails.firstName + ' ' + data.vendorDetails.lastName,
                                                bold: true,
                                                color: '#333333',
                                                fontSize: 12,
                                                alignment: 'right',
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                {
                                    border: [false, true, false, true],
                                    text: data.vendorDetails.distanceKM + ' KM',
                                    alignment: 'right',
                                    fillColor: '#f5f5f5',
                                    margin: [0, 5, 0, 5],
                                },
                            ...
                            [
                                ...
                                {
                                    text: data.vendorDetails.durationInMins,
                                    border: [false, false, false, true],
                                    fillColor: '#f5f5f5',
                                    alignment: 'right',
                                    margin: [0, 5, 0, 5],
                            ...
                            [
                                ...
                                {
                                    text: '₹ ' + data.vendorDetails.totalAmount,
                                    bold: true,
                                    fontSize: 20,
                                    alignment: 'right',
                                    border: [false, false, false, true],
